...
public class ObtenerServiciosPrestadosIncidentesController implements Handler {
  ServicioPrestadoRepositorio servicioPrestadoRepositorio;

  public ObtenerServiciosPrestadosIncidentesController(EntityManager entityManager){
  ...
  public void handle(@NotNull Context context) throws Exception {
    ...
    if(establecimientoId != null && establecimientoId != "") {
      List<ServicioPrestado> servicioPrestados = FiltradorPorComunidad.serviciosPrestadosDeComunidad(context.sessionAttribute("comunidad"),servicioPrestadoRepositorio.buscarPorEstablecimiento(establecimientoId));
