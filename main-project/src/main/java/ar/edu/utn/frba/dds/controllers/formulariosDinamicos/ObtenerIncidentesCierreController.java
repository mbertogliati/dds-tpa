...
public class ObtenerIncidentesCierreController implements Handler {
  IncidenteRepositorio incidenteRepositorio;

  public ObtenerIncidentesCierreController(EntityManager entityManager){
  ...
  public void handle(@NotNull Context context) throws Exception {
    ...
    if(localidadId != null && localidadId != "") {
      List<Incidente> incidentes = FiltradorPorComunidad.incidentesDeComunidad(context.sessionAttribute("comunidad"), incidenteRepositorio.buscarPorLocalidad(localidadId));
