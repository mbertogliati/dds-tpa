...
public class ObtenerLocalidadesIncidentesController implements Handler {
  ...
  public void handle(@NotNull Context context) throws Exception {
    ...
    if(departamentoId != null && departamentoId != "") {
      ...
      List<Localidad> localidades = FiltradorPorComunidad.localidadesDeComunidad(context.sessionAttribute("comunidad"), localidadRepositorio.buscarPorDepartamento(Integer.parseInt(departamentoId)));
